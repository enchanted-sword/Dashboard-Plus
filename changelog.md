...
- shrunk vertical navigation top margin
...
- now enabled for all touch devices
- fixed new tumblr reblog menu being supressed from opening

## revert post footer appearance

- added option to remove the extra click to reblog
...
## new feature! revert post footer appearance
